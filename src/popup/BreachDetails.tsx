import { Stack, Text, Button, Collapse, List, Center } from "@mantine/core"
import React from "react"
import { Ce, Database } from "tabler-icons-react"
import type { PWNED, styles } from "../types"
    ...
    return (
        <>
            <Center>
                ...
                <Text style={styles.text} order={5}>{breach.Name} Breaches</Text>
            </Center>
